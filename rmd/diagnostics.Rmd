...
prior distribution. The parameters of half-cauchy were changed a bit, as wel as the Normal distribution for betas. The results in most cases remained the same.
