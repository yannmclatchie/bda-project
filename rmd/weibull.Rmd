...
$$
where we construct $\eta = \exp(\boldsymbol X\beta)$, noting that $\eta$ is strictly positive. Thus we choose a log link function for our GLM such that
$$
...
$$
Connection between $\lambda$ and $\gamma$ is:
...
$$
\beta \sim Norm(0,1000)
$$

$$
\alpha \sim Gamma(0.1,0.1)
$$
